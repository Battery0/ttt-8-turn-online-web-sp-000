...
#A players turn that accepts input for board position they want to play assigned to variable 'input'. Turns that str input into an int thats used as the array indicies via #input_to_index helper method.
def turn(board)
